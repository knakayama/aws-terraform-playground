...
sub_domain        = "ap-northeast-1.aws.staging"
atlas_environment = "aws-ap-northeast-1-staging"
...
azs               = "ap-northeast-1a,ap-northeast-1c" # AZs are region specific
private_subnets   = "10.139.1.0/24,10.139.2.0/24" # Creating one private subnet per AZ
ephemeral_subnets = "10.139.11.0/24,10.139.12.0/24" # Creating one ephemeral subnet per AZ
public_subnets    = "10.139.101.0/24,10.139.102.0/24" # Creating one public subnet per AZ
...
consul_artifact_name = "aws-ap-northeast-1-ubuntu-consul"
...
vault_artifact_name = "aws-ap-northeast-1-ubuntu-vault"
...
haproxy_artifact_name = "aws-ap-northeast-1-ubuntu-haproxy"
...
nodejs_artifact_name       = "aws-ap-northeast-1-ubuntu-nodejs"
